...
<!--HOME PAGE DESKTOP VERSION-->
		...
		<p>Image 1 shows the Home Page desktop layout for lorchard.org. I prefer straight-forward layouts
			...
			the home page without having to scroll down (ifpossible). For this reason, I have a desktop
			layout that provides visual interest, obviouslinks to additional pages, and basic information
