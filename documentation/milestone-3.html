...
<html>
	...
	<body>
		...
		<p>
			...
			Created for: 	Deep Dive Coding Bootcamp, PWP Project Milestone III<br />
			Date:		May 9, 2015<br />
		...
		<ul>
			...
			<li>The coverflow/carousel in the center of the page will have text overlays on top of
				imagery - the text is informational, the imagery is artistic (my own photos).</li>
		...
		<figure role="group">
			<figure>
				...
				<figcaption>Image 1: Home Page Desktop Layout</figcaption>
			</figure>
		</figure>
		<!--Samples of the type of coverflow/carousel images

		<div class="photos">
			<img src="../images/new_photo.jpg" alt="Collaboration" />
			<img src="../images/new_photo2.jpg" alt="Adaptive" />
			<img src="../images/new_photo3.jpg" alt="Attention to Detail" />
			<img src="../images/new_photo4.jpg" alt="Persistence" />
		</div>
		-->
		...
		<figure role="group">
			<figure>
				...
				<figcaption>Image 2: Home Page Mobile Layout</figcaption>
			</figure>
		</figure>
		...
		<figure role="group">
			<figure>
				...
				<figcaption>Image 3: Work Page Desktop Layout</figcaption>
			</figure>
		</figure>
		...
		<figure role="group">
			<figure>
				...
				<figcaption>Image 4: Work Page Mobile Layout</figcaption>
			</figure>
		</figure>
		<figure role="group">
			<figure>
				<img src="../images/rikeryar.jpg" alt="Gratuitous Star Trek image" />
				<figcaption>Plus one for gratuitous Riker-Yar image..?</figcaption>
			</figure>
		</figure>
	</body>
</html>